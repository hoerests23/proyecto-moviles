...
import androidx.compose.material.icons.filled.List // Import para el icono de lista
                ...
                Column(
                    ...
                    AnimatedVisibility(
                        ...
                        Column(
                            ...
                            // --- BOTÓN MODIFICADO CON COLOR DEL TEMA ---
                            OutlinedButton(
                                onClick = { navController.navigate("pokemon_list") },
                                modifier = Modifier
                                    .fillMaxWidth()
                                    .height(56.dp),
                                // CAMBIO: Color del tema (Primary / Morado)
